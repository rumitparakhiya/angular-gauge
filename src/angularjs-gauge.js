(function (angular) {
    ...
    function gaugeMeterDirective(ngGauge) {
        ...
        var tpl = '<div style="display:inline-block;text-align:center;position:relative;outline-color:transparent;" ng-click="click()">' +
        ...
        Gauge.prototype = {
            ...
            drawShell: function (start, middle, tail, color) {
                ...
                if (borderWidth > 0) {
                    ...
                    context.arc(center.x, center.y, borderRadius, start, tail, false);
                    context.stroke();
                }
                ...
                context.arc(center.x, center.y, radius - borderWidth, start, middle, false);
                context.stroke();
            },
            ...
            getRadius: function () {
                ...
                return center.x - this.getThickness() / 2;
            },

            getBorderRadius: function () {
                var center = this.getCenter();
                return center.x - this.getBorderWidth() / 2;
            },
        ...
        return {
            ...
            link: function (scope, element) {
                ...
                scope.borderWidth = angular.isDefined(scope.borderWidth) && scope.borderWidth >= 0 ? scope.borderWidth : defaults.borderWidth;
                scope.borderColor = angular.isDefined(scope.borderColor) && scope.borderColor.trim() !== '' ? scope.borderColor : defaults.borderColor;
                if (angular.isUndefined(scope.click)) {
                    scope.click = angular.noop;
                }
                ...
                scope.$watch('borderWidth', watchOther, false);
                scope.$watch('borderColor', watchOther, false);
